...
import '../components/inweb_view_payment.dart';
...
class BottomSection extends ConsumerWidget {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Hero(
                ...
                child: CustomButton(
                  onPressed: () {
                    if (ref.read(selectedCustomerpaymentProvider) == null) {
  ...
  Future<void> posStore(
    ...
    final selectedPaymentMethod =
        ref.read(selectedCustomerpaymentProvider.notifier).state?.name;
    ...
    POSResponse? response =
      ...
      data: {
        ...
        // ref.read(selectedCustomerpaymentProvider.notifier).state?.name ==
        //         'online'
        //     ? ref.read(selectedCustomerpaymentProvider)
        //     : selectedCustomerpaymentProvider.name,
    ...
    if (response != null) {
      ...
      if (selectedPaymentMethod == "Draft") {
        context.nav.pop();
        GlobalFunction.showCustomSnackbar(
            message: "Order successfully Draft", isSuccess: true);
        //TODO: Hide this dialog. This will enable when Orange pay will be integrated
        // showDialog(
        //   context: context,
        //   barrierDismissible: false,
        //   barrierColor: AdaptiveTheme.of(context).mode.isDark
        ...
        //       final isLoading = ref.watch(paymentSuccessControllerProvider);
        //       return Column(
        //         mainAxisSize: MainAxisSize.min,
        //         children: [
        //           SizedBox(
        //             height: 60.h,
        //             width: 60.h,
        //             child: Assets.pngs.ornageMoney.image(
        //               fit: BoxFit.cover,
        //             ),
        //           ),
        //           Gap(20.h),
        //           CachedNetworkImage(imageUrl: response.qrUrl ?? ''),
        //           Gap(20.h),
        //           Text(
        //             "pleasePay",
        ...
        //                   onPressed: () {
        //                     context.nav.pop();
        //                     ref.invalidate(draftIdProvider);
        //                   },
        //                   text: "Unpaid",
        //                 ),
        //               ),
        ...
        //                         onPressed: () {
        //                           ref
        //                               .read(paymentSuccessControllerProvider
        //                                   .notifier)
        //                               .paymentSuccess(id: response.draftId!)
        //                               .then((value) async {
        //                             if (value == true) {
        //                               context.nav.pop();
        //                               ref.invalidate(draftIdProvider);
        ...
        if (selectedPaymentMethod != "Draft" &&
          ...
          final methodName = selectedPaymentMethod?.toLowerCase() ?? '';
      ...
      print("IDDDD ${response?.orderId ?? 0}");
      GlobalFunction.showCustomSnackbar(
